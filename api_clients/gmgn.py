# api_clients/gmgn.py - Fixed to work with new config structure
...
class GMGNClient:
    def __init__(self):
        ...
        self.api_key = API_KEYS.get("gmgn", "")  # GMGN is public API, no key needed
    ...
    def fetch_smart_trades(self, min_value=1000):
        try:
            ...
            print(f"Error fetching smart trades: {e}")
            return {"trades": []}  # Return empty trades if API fails
    ...
    def fetch_wallet_tags(self, wallet_address):
        try:
            ...
            print(f"Error fetching wallet tags: {e}")
            return {"tags": []}  # Return empty tags if API fails