...
class MoniClient(BaseAPIClient):
    ...
    def get_sentiment(self, token_address: str) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Moni sentiment analysis failed for {token_address}: {str(e)}")
            return {
                'token_address': token_address,
                'status': 'error',
                'message': str(e),
    ...
    def _process_sentiment_response(self, response: Dict, token_address: str) -> Dict[str, Any]:
    ...
    def _process_social_response(self, response: Dict, token_address: str) -> Dict[str, Any]:
