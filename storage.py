...
class Storage:
    ...
    def _init_tables(self):
        with self.conn:
            ...
            self.conn.execute("""CREATE TABLE IF NOT EXISTS smart_trades (
                id INTEGER PRIMARY KEY AUTOINCREMENT,
                wallet TEXT,
                token_address TEXT,
                value_usd REAL,
            ...
            self.conn.execute("""CREATE TABLE IF NOT EXISTS smart_accumulation (
                id INTEGER PRIMARY KEY AUTOINCREMENT,
                token_address TEXT,
                wallet TEXT,
                tags TEXT,
            ...
            self.conn.execute("""CREATE TABLE IF NOT EXISTS order_status (
                id INTEGER PRIMARY KEY AUTOINCREMENT,
                order_id TEXT,
                status TEXT,
                recorded_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
